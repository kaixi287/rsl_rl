...
class ActorCriticTransformer(ActorCritic):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.memory_a = TransformerMemory(num_actor_obs, transformer_num_heads, transformer_num_layers, d_model, d_ff, dropout=0.0)
        self.memory_c = TransformerMemory(num_critic_obs, transformer_num_heads, transformer_num_layers, d_model, d_ff, dropout=0.0)
